...
public class PracticalTest02MainActivity extends Activity {
	...
	// Client widgets
	private EditText 	 stringAutocompleteText	  = null;
	...
	private class GetWeatherForecastButtonClickListener implements Button.OnClickListener {
		...
		public void onClick(View view) {
			...
			String autocompleteString = stringAutocompleteText.getText().toString();
			//String informationType = informationTypeSpinner.getSelectedItem().toString();
			if (autocompleteString == null || autocompleteString.isEmpty()) {
				Toast.makeText(
					getApplicationContext(),
					"Parameters from client (autocomplete string) should be filled!",
					Toast.LENGTH_SHORT
				).show();
				return;
			}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		stringAutocompleteText = (EditText)findViewById(R.id.city_edit_text);
